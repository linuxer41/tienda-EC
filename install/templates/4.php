<?php require INSTALL_PATH . 'templates/header.php';?>
	...
	<div class="btn-box">
		<a href="javascript:;" class="btn_old" id="installloading">
			<img src="templates/images/loading.gif" align="absmiddle">&nbsp;Instalando ...
		</a>
	</div>
		...
		function reloads(n) {
			...
			$.ajax({
				...
				success: function(data){
					...
					if(data.status == 2){
						$('#installloading').removeClass('btn_old').addClass('btn').attr('href','./index.php?step=5').html('La instalación está completa ...');
						setTimeout(function(){

...
(256, 'El tema de la página de inicio móvil incluyó espacios publicitarios', 360, 168, '', '{foreach from=$ads item=ad name=ads}{if $smarty.foreach.ads.iteration % 2 == 0}<li class="fl">{else}<li class="fr">{/if}{$ad}</li>{/foreach}');
...
INSERT INTO `ecs_ad_position` (`position_id`, `position_name`, `ad_width`, `ad_height`, `position_desc`, `position_style`) VALUES
(257, 'Página de inicio del teléfono móvil promoción de tiempo limitado espacio publicitario 1', 360, 168, '', '{foreach from=$ads item=ad name=ads}{$ad}{/foreach}');
INSERT INTO `ecs_ad_position` (`position_id`, `position_name`, `ad_width`, `ad_height`, `position_desc`, `position_style`) VALUES
(258, 'Página de inicio del teléfono móvil promoción por tiempo limitado espacio publicitario 2', 360, 168, '', '{foreach from=$ads item=ad name=ads}{$ad}{/foreach}');
INSERT INTO `ecs_ad_position` (`position_id`, `position_name`, `ad_width`, `ad_height`, `position_desc`, `position_style`) VALUES
(259, 'Página de inicio del teléfono móvil actividad popular espacio publicitario 1', 360, 168, '', '{foreach from=$ads item=ad name=ads}{$ad}{/foreach}');
INSERT INTO `ecs_ad_position` (`position_id`, `position_name`, `ad_width`, `ad_height`, `position_desc`, `position_style`) VALUES
(260, 'Espacio popular de publicidad móvil en la página de inicio móvil 2', 360, 168, '', '{foreach from=$ads item=ad name=ads}{$ad}{/foreach}');
INSERT INTO `ecs_ad_position` (`position_id`, `position_name`, `ad_width`, `ad_height`, `position_desc`, `position_style`) VALUES
(261, 'Página principal de publicidad móvil recomendada 1', 360, 168, '', '{foreach from=$ads item=ad name=ads}{$ad}{/foreach}');
INSERT INTO `ecs_ad_position` (`position_id`, `position_name`, `ad_width`, `ad_height`, `position_desc`, `position_style`) VALUES
(262, 'Página de inicio del teléfono móvil espacio publicitario recomendado 2', 360, 168, '', '{foreach from=$ads item=ad name=ads}{$ad}{/foreach}');
INSERT INTO `ecs_ad_position` (`position_id`, `position_name`, `ad_width`, `ad_height`, `position_desc`, `position_style`) VALUES
(263, 'Teléfono móvil casa marca calle publicidad espacio 1', 360, 168, '', '{foreach from=$ads item=ad name=ads}{$ad}{/foreach}');
INSERT INTO `ecs_ad_position` (`position_id`, `position_name`, `ad_width`, `ad_height`, `position_desc`, `position_style`) VALUES
(264, 'Teléfono móvil casa marca calle publicidad espacio 2', 360, 168, '', '{foreach from=$ads item=ad name=ads}{$ad}{/foreach}');
...
-- ----------------------------
INSERT INTO `ecs_attribute` VALUES ('1', '1', 'Memoria', '1', '1', '32GB\r\n128GB\r\n256GB', '0', '0', '0', '0');
INSERT INTO `ecs_attribute` VALUES ('2', '1', 'Color', '1', '1', 'Negro mate\r\n Gris gris cielo', '0', '0', '0', '0');


-- ----------------------------
-- Records of ecs_category
-- ----------------------------
INSERT INTO `ecs_category` VALUES ('1', 'Computadora', '', '', '0', '50', '', '', '0', '', '1', '0', '0');
INSERT INTO `ecs_category` VALUES ('2', 'Ratón', '', '', '1', '50', '', '', '0', '', '1', '0', '0');
INSERT INTO `ecs_category` VALUES ('3', 'Auriculares', '', '', '1', '50', '', '', '0', '', '1', '0', '0');
INSERT INTO `ecs_category` VALUES ('4', 'Comunicación', '', '', '0', '50', '', '', '0', '', '1', '0', '0');
INSERT INTO `ecs_category` VALUES ('5', 'Celular', '', '', '4', '50', '', '', '0', '', '1', '0', '0');
INSERT INTO `ecs_category` VALUES ('6', 'Reloj inteligente', '', '', '4', '50', '', '', '0', '', '1', '0', '0');

-- ----------------------------
-- Records of ecs_goods
-- ----------------------------
INSERT INTO `ecs_goods` VALUES ('1', '2', 'ECS000000', 'Ratón Razer', '+', '2', '0', '', '100', '0.000', '105.60', '88.00', '0.00', '0', '0', '1', '雷蛇 鼠标', '', '', 'data/attached/images/201805/thumb_img/1_thumb_G_1526429499181.jpg', 'data/attached/images/201805/goods_img/1_G_1526429499336.jpg', 'data/attached/images/201805/source_img/1_G_1526429499247.jpg', '1', '', '1', '1', '0', '0', '1526429499', '100', '0', '1', '0', '0', '0', '0', '1526429526', '0', '', '-1', '-1', '0', null, '0');
INSERT INTO `ecs_goods` VALUES ('2', '3', 'ECS000002', 'Auriculares Razer para juegos', '+', '1', '0', '', '1000', '0.000', '153.60', '128.00', '99.00', '1494316800', '1592121600', '1', '耳机 游戏', '', '', 'data/attached/images/201805/thumb_img/2_thumb_G_1526429627326.jpg', 'data/attached/images/201805/goods_img/2_G_1526429627021.jpg', 'data/attached/images/201805/source_img/2_G_1526429627024.jpg', '1', '', '1', '1', '0', '1', '1526429627', '100', '0', '1', '1', '0', '1', '0', '1526429645', '0', '', '-1', '-1', '0', null, '0');
...
INSERT INTO `ecs_goods_attr` VALUES ('4', '3', '2', 'Negro mate', '0');
INSERT INTO `ecs_goods_attr` VALUES ('5', '3', '2', 'Gris estrellado', '0');
...
-- ----------------------------
INSERT INTO `ecs_goods_type` VALUES ('1', 'Celular', '1', '');

      ...
      <td colspan="2" height="90" class="mainhd"><div class="layout-header"> <!-- Title/Logo - can use text instead of image -->
          ...
          <div id="topnav" class="top-nav">
            <ul>
              ...
              <li><a href="index.php?act=clear_cache" target="workspace">Act. caché</a></li>
              <li><a href="privilege.php?act=modif" target="workspace"><span><?php echo $this->_var['lang']['profile']; ?></span></a></li>
              <li><a href="privilege.php?act=modif" target="workspace">Hola&nbsp;:&nbsp;<?php echo $_SESSION['admin_name']; ?></a></li>
            </ul>
          </div>
...
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          ...
          <div class="loca"><strong>Su ubicación:</strong>
            <div id="crumbs" class="crumbs"><span>Consola</span><span class="arrow">&nbsp;</span><span>Página de bienvenida</span> </div>
          </div>
          <div class="toolbar">
            <div class="sitemap"><a id="siteMapBtn" href="#rhis" onclick="showBg('dialog','dialog_content');"><span>Mapa de gestion</span></a></div>
          </div>
        </div>
        <div > </div></td>
    </tr>
...
?>
        ...
        <p>Powered By <em><a href="http://www.xydai.cn" target="_blank"><span class="vol"><font class="b">Linuxer</font><font class="o">.Cn</font></span></a></em></p></div></td>

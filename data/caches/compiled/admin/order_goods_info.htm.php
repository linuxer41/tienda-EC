...
?>
  <tr>
    ...
    <td><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" /><br /><a href="../index.php?c=goods&id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><?php echo $this->_var['goods']['goods_name']; ?> <?php if ($this->_var['goods']['brand_name']): ?>[ <?php echo $this->_var['goods']['brand_name']; ?> ]<?php endif; ?>

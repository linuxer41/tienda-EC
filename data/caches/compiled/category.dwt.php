				...
				<section class="search">
					<div class="text-all dis-box j-text-all text-all-back">
						...
						<div class="box-flex input-text n-input-text i-search-input">
							...
							<input class="j-input-text" type="text" placeholder="Buscar">
...
$('#hide-div').delay(1500).hide(0);
	var sliders = function() {
		...
		$("#slider-range").slider({
			range: true,
			min: <?php echo $this->_var['price_range']['min']; ?>,
			max: <?php echo $this->_var['price_range']['max']; ?>,
			step: <?php echo $this->_var['range_step']; ?>,
			values: [<?php echo $this->_var['price_min']; ?>, <?php if ($this->_var['price_max']): ?><?php echo $this->_var['price_max']; ?><?php else: ?><?php echo $this->_var['price_range']['max']; ?><?php endif; ?>],

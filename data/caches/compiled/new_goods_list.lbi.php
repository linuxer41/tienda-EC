		...
		<li>
			<div class="product-div">
				...
				<div class="product-text">
					<h4>{{vo.goods_name}}</h4>
					<p class="dis-box p-t-remark"><span class="box-flex">Inventario{{vo.goods_number}}<?php echo $this->_var['category']['measure_unit']; ?></span><!--<span class="box-flex">é”€é‡ï¼š{{vo.sales_count}}<?php echo $this->_var['category']['measure_unit']; ?></span>--></p>

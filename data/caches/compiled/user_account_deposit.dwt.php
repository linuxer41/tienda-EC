...
?>
								<li class="ect-select j-checkbox-all">
									...
									<label class="ts-1" for="zf<?php echo $this->_var['list']['pay_id']; ?>"><i class="fr iconfont icon-gou ts-1"></i><?php echo $this->_var['list']['pay_name']; ?>(<?php echo $this->_var['list']['pay_fee']; ?>Tarifa de Pago)</label>
								</li>

			...
			<div class="goods-box">
						...
						<div class="ect-header-banner dis-box">
							<div class="box-flex">
								<div class="ect-header-text fl">
									<h4>Bienvenido a <span class="color-red">Cool Store</span></h4>
									<p>Todo es posible</p>
								</div>
							</div>
							<a class="btn-submit1 j-ewm-box" href="javascript:;">Sigue ahora</a>
						</div>
						<div class="index-weixin-box">
							<div><img src="__TPL__/statics/img/ewm.png"></div>
							<p class="text-c">Mantenga presionado el código QR para seguir al público WeChat</p>
						</div>
					...
					<div class="box-flex">
						<ul class="dis-box goods-header-nav-box">
							<li class="box-flex"><a class="hover" href="javascript:;"><label>Producto</label></a></li>
							<li class="box-flex"><a href="#n-goods"><label>Detalles</label></a></li>
							<li class="box-flex"><a href="<?php echo url('goods/comment_list',array('id'=>$this->_var['goods']['goods_id']));?>"><label>Evaluación</label></a></li>
						</ul>
					</div>
					...
					<div class="goods-nav ts-3">
						<ul class="goods-nav-box">
						    <a href="<?php echo url('index/index');?>">
								<li><i class="iconfont icon-home j-nav-box"></i>inicio</li>
							</a>
							<a href="<?php echo url('user/msg_list');?>">
								<li><i class="iconfont icon-xiaoxi1 j-nav-box"></i>Noticias</li>
							</a>
							<a href="<?php echo url('user/index');?>">
								<li><i class="iconfont icon-geren j-nav-box"></i>Cuenta</li>
							</a>
							<a href="<?php echo url('user/order_list');?>">
								<li style="border:none"><i class="iconfont icon-quanbudingdan j-nav-box"></i>Todos los pedidos</li>
							</a>
						</ul>
					</div>
				</header>
		...
		<div class="goods-info">
			...
			<section class="goods-price padding-all b-color-f">
				<p class="p-price">
					...
					<em class="em-promotion">Canjeable con Puntos</em>
				</p>
				<?php if (goods.is__promote && $this->_var['goods']['gmt_end_time']): ?>

				<?php else: ?>
				<p class="p-market"style="color:red;">
					Precio a cliente <?php echo $this->_var['goods']['rank_price_formated']; ?>
				</p>
				<?php endif; ?>
				<?php if ($this->_var['cfg']['SHOW_MARKETPRICE']): ?>
				<p class="p-market">
					Precio de mercado <del><?php echo $this->_var['goods']['market_price']; ?></del>
				</p>
				<?php endif; ?>
				<p class=" dis-box g-p-tthree m-top04">
					...
					<span class="box-flex text-right">Inventario: <?php echo $this->_var['goods']['goods_number']; ?></span>
				</p>
			</section>
...
?>
			...
			<section class="padding-all b-color-f1 goods-service">
				<div class="dis-box">
					<div class="box-flex">
						<div class="dis-box">
							<p class="box-flex t-goods2">Este servicio es proporcionado por <?php echo $this->_var['shop_name']; ?>. Brinda servicios postventa y soporte de producto.</p>
						...
						<div class="dis-box m-top08 g-r-rule goods-service-list">
							<p class="box-flex t-remark3">
								<em class="fl em-promotion"><i class="iconfont icon-weibiaoti11"></i></em><span class="fl">Garantía</span></p>
							<p class="box-flex t-remark3">
								<em class="fl em-promotion"><i class="iconfont icon-daifukuan"></i></em><span class="fl">Reembolso</span></p>
							<p class="box-flex t-remark3">
								<em class="fl em-promotion"><i class="iconfont icon-7tianwuliyoutuihuo"></i></em><span class="fl">Dev. 7 Dias</span></p>
							<p class="box-flex t-remark3">
								<em class="fl em-promotion"><i class="iconfont icon-taobaojisutuikuan"></i></em><span class="fl">Velocidad</span></p>
						</div>
					</div>
				</div>
			</section>
			...
			<section class="goods-num-box b-color-f text-c f-05 padding-all">
				<ul class=" dis-box goods-box-bor">
					<li class="box-flex goods-bor goods-b-n">Cantidad de oferta</li>
					<li class="box-flex goods-bor goods-b-n">Precio preferencial</li>
				</ul>
...
?>
      ...
      <a class="ect-padding-lr ect-padding-tb" href="<?php echo url('goods/comment_list',array('id'=>$this->_var['goods']['goods_id']));?>"><span class="Text"><?php echo $this->_var['lang']['goods_comment']; ?></span> <span class="pull-right"><span class="ect-color"><?php echo $this->_var['comments']['count']; ?></span><?php echo $this->_var['lang']['comment_num']; ?> <span class="ect-color"><?php echo $this->_var['comments']['favorable']; ?>%</span><?php echo $this->_var['lang']['favorable_comment']; ?> <i class="fa fa-chevron-right"></i></span></a>  -->
				...
				<section class="m-top10 padding-all b-color-f goods-attr j-goods-attr j-show-div">
					<div class="dis-box">
						<label class="t-remark g-t-temark">Seleccionado</label>
						<div class="box-flex t-goods1 ">Por favor seleccione</div>
						...
						<section class="s-g-attr-title b-color-1  product-list-small">
							<div class="product-div">
								...
								<div class="product-text n-right-box">
									...
									<p class="dis-box p-t-remark"><span class="box-flex" id="ECS_PRODUCT_NUMBER">Inventario:<?php echo $this->_var['goods']['goods_number']; ?></span></p>
								</div>
							</div>
						</section>
...
?>
						...
						<section class="ect-button-more dis-box padding-all">
							<a class="btn-cart box-flex show-div-guanbi n-btn-box"  type="button" onClick="addToCart(<?php echo $this->_var['goods']['goods_id']; ?>);">Añadir al carrito</a>
							<a class="btn-submit box-flex" type="button" onClick="addToCart_quick(<?php echo $this->_var['goods']['goods_id']; ?>);">Comprar ahora</a>
						</section>
			</form>
			</div>
			...
			<section class="m-top10 goods-evaluation">
				<a href="<?php echo url('goods/comment_list',array('id'=>$this->_var['goods']['goods_id']));?>">
					<div class="dis-box padding-all b-color-f  g-evaluation-title">
						<label class="t-remark g-t-temark">Evaluación</label>
						<div class="box-flex t-goods1">Popularidad <em class="t-first"><?php echo $this->_var['comments']['favorable']; ?>%</em></div>
						<div class="t-goods1"><em class="t-first"><?php echo $this->_var['goods']['comment_count']; ?></em><span class="t-jiantou"><?php echo $this->_var['comments']['count']; ?>  Comentarios<i class="iconfont icon-jiantou tf-180"></i></span></div>
					</div>
				</a>
...
?>
					...
					<div class="of-hidden evaluation-list padding-all-1 n-list-pl">
						...
						<?php endif; ?>
						<p style="display:none;" class="clear m-top08 t-remark">Clasificación del color: 70cm, azul 5144</p>
					</div>
					<?php endif; ?>
					<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
					...
					<p class="clear m-top10 t-goods1">Se ve bien, el tamaño es el correcto</p>
					<p class="clear m-top08 t-remark">Clasificación del color: 70 cm, azul 5144</p>
					<div class="ect-button-more m-top10 dis-box">
						<a class="box-flex btn-default">Evaluación gráfica</a>
						<a href="<?php echo url('goods/comment_list',array('id'=>$this->_var['goods']['goods_id']));?>" class="box-flex btn-default">Todos los comentarios</a>
					</div>
				</div>-->
				</div>
			</section>
			<!-- <section class="padding-all text-center t-remark2 xiangqing-1 ">
			<a href="<?php echo url('goods/info',array('id'=>$this->_var['goods']['goods_id']));?>" class="j-goodsinfo-div">Haga clic para ver los detalles del producto.</a>
		</section> -->
...
var select_base = 'Por favor seleccione el paquete básico';
var select_shop = 'Por favor seleccione un paquete de producto';
var data_not_complete = 'Formato de datos incompleto';
var understock = 'Stock insuficiente, elija otro producto';

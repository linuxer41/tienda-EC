...
<div class="con m-b7">
					...
					<div class="user-right-maxbox">
						<a href="<?php echo url('user/profile');?>">
							<div class="user-right-box">
								...
								<p class="my-user-right-cont"><span class="my-t-remark color-whie">Configurar</span></p>
							</div>
						</a>
		...
		<div class="my-nav-box my-shoucang-bg">
			<div class="user-nav-box n-g-s-i-title-1 dis-box text-center">
				<a href="<?php echo url('user/collection_list');?>" class="box-flex">
					...
					<p class="color-whie t-remark3">Favorito</p>
				</a>
				<a href="<?php echo url('user/msg_list');?>" class="box-flex">
					...
					<p class="color-whie t-remark3">Noticias</p>
				</a>
			</div>
		</div>
	</div>
	<section class="b-color-f my-nav-box m-top10">
		<a href="<?php echo url('user/order_list');?>">
			<div class="dis-box padding-all my-bottom">
				<h3 class="box-flex text-all-span my-u-title-size"><i class="iconfont icon-quanbudingdan is-user-size t-first"></i>Mi orden</h3>
				<div class="box-flex t-goods1 text-right onelist-hidden jian-top">Todos los pedidos</div>
	...
	<section class="m-top10 my-nav-box b-color-f">
		<a href="<?php echo url('user/account_detail');?>">
			<div class="dis-box padding-all my-bottom">
				<h3 class="box-flex text-all-span my-u-title-size"><i class="iconfont icon-qianbao is-user-size my-qianbao-color"></i>Mi billetera</h3>
				<div class="box-flex t-goods1 text-right onelist-hidden jian-top">Gestión del dinero</div>
				<span class="t-jiantou"><i class="iconfont icon-jiantou tf-180 jian-top"></i></span>
			</div>
		</a>
		<ul class="user-money-list g-s-i-title-1 dis-box text-center">
			<div  class="box-flex">
				<li>
					...
					<p class="t-remark3">Equilibrio</p>
				</li>
			</div>
	...
	<footer class="b-color-f user-fu-box m-top10">
		<div class="box text-c b-color-f dis-box">
			<a href="<?php echo url('user/service');?>" class="box-flex">
				...
				<p class="f-03 col-6">Servicio al cliente</p>
			</a>
			<a href="<?php echo url('user/share');?>" class="box-flex">
				<i class="iconfont icon-fenxiang"></i>
				<p class="f-03 col-6">Mi parte</p>
			</a>
	...
	<section class="m-top10 my-nav-box">
		<div class="dis-box padding-all b-color-f">
			...
			<span class="jian-top n-shanchutupian del"><i class="iconfont icon-xiao10 is-xiao10 jian-top"></i><span class="q-title jian-top">Claro</span>
		</div>
...
<footer class="footer-nav dis-box">
	...
	<a href="<?php echo url('user/index');?>" class="box-flex nav-list active">
		<i class="nav-box i-user"></i><span>La mia</span>
	</a>
</footer>

...
class UserController extends CommonController
{
    ...
    public function profile()
    {
        ...
        if (IS_POST) {
            ...
            if (!empty($mobile_phone) && preg_match('/^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}$/im', $mobile_phone)) {
    ...
    */
    public function not_shoushuo()
    {
        ...
        $this->assign('pay', $pay);
        $this->assign('title', 'Ser recibido');
        $this->assign('pager', $this->pageShow($count));
        $this->assign('orders_list', $orders);
        $this->display('user_order_list.dwt');
    }
    ...
    public function account_bind()
    {
        ...
        $this->assign('page_title', 'Gestión de autorizaciones');
    ...
    public function order_comment()
    {
        ...
        if (!$goods) {
            show_message('Sin contenido', 'Volver', url('user/index'));
        }
        $this->assign('title', 'Evaluacion');
